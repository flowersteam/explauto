...
latex_documents = [
  ('index', 'models.tex', u'models Documentation',
...
man_pages = [
    ('index', 'models', u'models Documentation',
...
texinfo_documents = [
  ('index', 'models', u'models Documentation',
   u'Fabien Benureau and Clement Moulin-Frier', 'models', 'One line description of project.',
   'Miscellaneous'),
]
